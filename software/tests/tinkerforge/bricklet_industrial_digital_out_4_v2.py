# -*- coding: utf-8 -*-
#############################################################
# This file was automatically generated on 2020-10-20.      #
#                                                           #
...
class BrickletIndustrialDigitalOut4V2(Device):
    ...
    FUNCTION_WRITE_WIEGAND_DATA_LOW_LEVEL = 11
    FUNCTION_GET_WIEGAND_STATE = 12
    ...
    WIEGAND_STATE_IDLE = 0
    WIEGAND_STATE_BUSY = 1
    ...
    def __init__(self, uid, ipcon):
        ...
        self.response_expected[BrickletIndustrialDigitalOut4V2.FUNCTION_WRITE_WIEGAND_DATA_LOW_LEVEL] = BrickletIndustrialDigitalOut4V2.RESPONSE_EXPECTED_TRUE
        self.response_expected[BrickletIndustrialDigitalOut4V2.FUNCTION_GET_WIEGAND_STATE] = BrickletIndustrialDigitalOut4V2.RESPONSE_EXPECTED_ALWAYS_TRUE
        ...
        self.callback_formats[BrickletIndustrialDigitalOut4V2.CALLBACK_WIEGAND_DONE] = (8, '')
    ...
    def write_wiegand_data_low_level(self, data_length, data_data):
        """
        TBD
        ...
        data_data = list(map(bool, data_data))

        self.ipcon.send_request(self, BrickletIndustrialDigitalOut4V2.FUNCTION_WRITE_WIEGAND_DATA_LOW_LEVEL, (data_length, data_data), 'H 256!', 0, '')

    def get_wiegand_state(self):
        """
        TBD
        ...
        return self.ipcon.send_request(self, BrickletIndustrialDigitalOut4V2.FUNCTION_GET_WIEGAND_STATE, (), '', 9, 'B')
    ...
    def write_wiegand_data(self, data):
        ...
        if data_length > 256:
            raise Error(Error.INVALID_PARAMETER, 'Data can be at most 256 items long')
